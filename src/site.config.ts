...
export const integ: IntegrationUserConfig = {
  ...
  waline: {
    enable: true,
    // Server service link
    server: 'http://waline-5qs6axhcd-jeffs-projects-7d39acfc.vercel.app/',
    ...
    additionalConfigs: {
      ...
      locale: {
        reaction0: 'Like',
        placeholder: 'Leave a comment! (Add email to receive replies. Login is unnecessary)'
      },
      imageUploader: false
    }
  }
